...
$query = "SELECT COUNT(id_re) FROM relevantes";
...
<div class="nuevo">
                    <a href="relevante_nuevo.php"><font color="#000000">Nuevo +</font></a>
                </div>
<div id="caja">
	<p id="titulo_orden">
...
<?php              
mysql_select_db($database_con_admin, $con_admin);
$qry2 = "SELECT * FROM relevantes ORDER BY orden ASC $pages2->limit";
...
<div id="caja">
    ...
    <img src="../img/relevantes/<?php echo $ima; ?>" width="330" height="135" class="img_banner"/>
    
</div>
<div id="boton_1">
	<button class="boton-formulario" onclick="location.href='relevante_editar.php?id_re=<?php echo $ids; ?>&menu=inicio.php'">Actualizar</button>
</div>
<div id="boton_2">
	<button class="boton-formulario2" onclick="if (confirm('¿Desea eliminar la Relevante: <?php echo $ima; ?>?')==true){window.location.href='relevante_eliminar.php?id_re=<?php echo $ids; ?>&menu=relevantes.php'}">Eliminar</button>
</div>
<?php
	}
}
