...
<?php
mysql_select_db($database_con_admin, $con_admin);
$qryt = "SELECT * FROM op1 WHERE seccion='seccion8'";
       ...
       <input name="seccion" type="hidden" value="<?php echo $sec; ?>" />
          <tr>
            ...
            <td width="614" valign="top"><table width="614" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="30" align="left" valign="middle" class="texto"><input name="Guardar" type="submit" class="boton-formulario" id="Guardar" value="Guardar" />
                </td>
              </tr>
            </table></td>
            </tr>
...
{
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE op1 SET titulo='$titulo' WHERE id_op='$id_op'";	
			mysql_query($qry44, $con_admin) or die(mysql_error());
			echo "<SCRIPT LANGUAJE='javascript'>window.location='promociones.php?menu=promociones.php'</SCRIPT>";
}
?>