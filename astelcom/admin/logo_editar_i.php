...
$qry2 = "SELECT * FROM logos WHERE id_lo='$id_lo'";
      ...
      <tr>
        <td align="center"><table width="1000" border="0" cellspacing="0" cellpadding="0">
              ...
              <td width="614" valign="top"><table width="614" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="614" height="25" align="left" valign="top" class="texto"><input name="imagen" type="file" class="boton2" id="imagen" style="width:400px;"/>
                      <br/><br/><br/><img src="../img/logos/<?php echo $ima; ?>" width="100" height="100"/>
                  </td>
                  </tr>
                <tr>
                  <td height="10" class="texto"><span class="pie-naranja"><strong>Tamaño de Imágen: </strong></span>100 x 35 px</td>
                  </tr>
                <tr>
          ...
          <tr>
            <th width="82" scope="col">&nbsp;</th>
            <th scope="col">&nbsp;</th>
            <th height="40" align="left" scope="col"><form id="form2" name="form2" method="post" action="logo_editar-eliminar.php?menu=<?php echo $menu;?>">
...
if (isset($_POST['guardar']))
{
	...
	{ 
		if ( (strpos($tipo_archivo4 , "jpeg") || strpos($tipo_archivo4 , "jpg")|| strpos($tipo_archivo4 , "png") || strpos($tipo_archivo4 , "gif")) && ($tamano_imagen4 < 914400000) ) 
		{
			...
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE logos SET imagen='$nombre_archivo4', orden='$orden' WHERE id_lo=".$ids."";
			mysql_query($qry44, $con_admin) or die(mysql_error());	
			echo"<script language='javascript'>window.location='logo_editar-eliminar.php?menu=".$menu."'</script>";
		}
		else
		{  
			echo "<script languaje='javascript'>alert('ERROR EN LA IMAGEN')</script>";
			echo"<script language='javascript'>window.location='logo_editar_i.php?menu=".$menu."&id_lo=".$ids."'</script>";	
		}	
	}
	else
	{
		mysql_select_db($database_con_admin, $con_admin);
       $qry44 = "UPDATE logos SET orden='$orden' WHERE id_lo=".$ids."";
		mysql_query($qry44, $con_admin) or die(mysql_error());	
		echo"<script language='javascript'>window.location='logo_editar-eliminar.php?menu=".$menu."'</script>";
	}
}
