...
<?php
mysql_select_db($database_con_admin, $con_admin);
$qryt = "SELECT * FROM op1 WHERE seccion='seccion11'";
       ...
       <input name="seccion" type="hidden" value="<?php echo $sec; ?>" />
          <tr>
            <td height="166" valign="top"><table width="82" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="20" align="left" valign="middle" class="texto">Subtítulo</td>
              </tr>
              <tr>
                <td height="40" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="82" height="32" align="left" valign="middle" class="texto" scope="col">Texto1</th>
              </tr>         
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="82" height="32" align="left" valign="middle" class="texto" scope="col">Texto2</th>
              </tr>         
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="82" height="32" align="left" valign="middle" class="texto" scope="col">Texto3</th>
              </tr>         
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="82" height="32" align="left" valign="middle" class="texto" scope="col">Texto4</th>
              </tr>         
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="82" height="32" align="left" valign="middle" class="texto" scope="col">Texto5</th>
              </tr>         
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="82" height="32" align="left" valign="middle" class="texto" scope="col">Texto6</th>
              </tr>         
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
            ...
            <td width="614" valign="top"><table width="614" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <th width="614" height="32" align="left" valign="middle" class="texto" scope="col">
                  <input type="text" name="tex1" id="tex1" style="width:500px;" value="<?php echo $te1; ?>" /></th>
              </tr>              
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="614" height="32" align="left" valign="middle" class="texto" scope="col">
                  <input type="text" name="tex2" id="tex2" style="width:500px;" value="<?php echo $te2; ?>" /></th>
              </tr>              
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="614" height="32" align="left" valign="middle" class="texto" scope="col">
                  <input type="text" name="tex3" id="tex3" style="width:500px;" value="<?php echo $te3; ?>" /></th>
              </tr>              
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="614" height="32" align="left" valign="middle" class="texto" scope="col">
                  <input type="text" name="tex4" id="tex4" style="width:500px;" value="<?php echo $te4; ?>" /></th>
              </tr>              
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="614" height="32" align="left" valign="middle" class="texto" scope="col">
                  <input type="text" name="tex5" id="tex5" style="width:500px;" value="<?php echo $te5; ?>" /></th>
              </tr>              
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
              <tr>
                <th width="614" height="32" align="left" valign="middle" class="texto" scope="col">
                  <input type="text" name="tex6" id="tex6" style="width:500px;" value="<?php echo $te6; ?>" /></th>
              </tr>              
              <tr>
                <td height="30" align="left" valign="middle">&nbsp;</td>
              </tr>
           ...
           <tr>
            ...
            <th scope="col">&nbsp;</th>
            <th align="left" scope="col"><form id="form2" name="form2" method="post" action="<?php echo $menu; ?>?menu=<?php echo $menu; ?>">
...
{
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE op1 SET titulo='$titulo',subtitulo='$subtitulo',descripcion='$tex1',descripcion2='$tex2',url='$tex3',tex1='$tex4',tex2='$tex5',tex3='$tex6' WHERE id_op='$id_op'";	
