...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="relevante_nuevo.php">
<div id="caja">
	<p class="textoboldnaranja" id="titulo_seccion" name="titulo_seccion">Relevantes</p>
...
<div id="caja_tamaños">
    ...
    <span class="pie-naranja"><strong>Tamaño de Imágen: </strong></span>169 x 100 px</p>
</div>
...
<form id="form2" name="form2" method="post" action="relevantes.php?menu=inicio.php">
<p id="boton_2">
...
if (isset($_POST['guardar']))
{
	...
	{ 
		if ( strpos($tipo_archivo4 , "png") || strpos($tipo_archivo4 , "gif") ||(strpos($tipo_archivo4 , "jpeg")) ) 
		{
			...
			$qry44 = "INSERT INTO relevantes (imagen,orden,titulo) VALUES ('$nombre_archivo4','$orden', '$titulo')";
			mysql_query($qry44, $con_admin) or die(mysql_error());
			echo "<SCRIPT LANGUAJE='javascript'>window.location='relevantes.php' </SCRIPT>";	
		}
		else
		{  
			echo "<script languaje='javascript'>alert('ERROR EN LA IMAGEN')</script>";
			echo"<script language='javascript'>window.location='relevante_nuevo.php'</script>";	
		}	
	}
	else
	{
