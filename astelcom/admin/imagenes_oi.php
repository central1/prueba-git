...
$query = "SELECT COUNT(id_im) FROM imagenes";
...
<div class="nuevo">
                    <a href="imagen_nueva.php?menu=promociones.php"><font color="#000000">Nueva Imagen +</font></a>
                </div>
<div id="caja">
	<p id="titulo_orden">
...
<?php              
mysql_select_db($database_con_admin, $con_admin);
$qry2 = "SELECT * FROM imagenes ORDER BY orden ASC $pages2->limit";
...
<div id="caja">
    ...
    <img src="../img/imagenes/<?php echo $ima; ?>" width="330" height="135" class="img_banner"/>
    
</div>
<div id="boton_1">
	<button class="boton-formulario" onclick="location.href='imagen_editar.php?id_im=<?php echo $ids; ?>&menu=promociones.php'">Actualizar</button>
</div>
<div id="boton_2">
	<button class="boton-formulario2" onclick="if (confirm('¿Desea eliminar la imagen: <?php echo $ima; ?>?')==true){window.location.href='imagen_eliminar.php?id_im=<?php echo $ids; ?>&menu=promociones.php'}">Eliminar</button>
</div>
<?php
	}
}
?>
<form id="form2" name="form2" method="post" action="promociones.php">
