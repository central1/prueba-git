...
$qry = "SELECT * FROM op1 WHERE seccion='seccion21'";
       ...
       <input name="imagen" type="hidden" value="<?php echo $ima; ?>" />
          ...
          <tr>
            <td height="166" valign="top"><table width="82" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th width="82" height="32" align="left" valign="middle" class="texto" scope="col"><p>Título</p>
                  <p>Telefono</p></th>
              </tr>         
              <tr>
...
if (isset($_POST['Guardar']))
{
			...
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE op1 SET titulo='$titulo',subtitulo='$subtitulo',descripcion='$descripcion' WHERE id_op='$id_op'";	
			mysql_query($qry44, $con_admin) or die(mysql_error());
			echo "<SCRIPT LANGUAJE='javascript'>window.location='servicios.php'</SCRIPT>";
}
?>