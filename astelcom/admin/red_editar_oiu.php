...
$qry2 = "SELECT * FROM redes WHERE id_red='$id_red'";
        ...
        <td align="center"><table width="1000" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <th colspan="3" align="left" scope="col"><table width="392" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th width="100" align="left" scope="col"><span class="textoboldnaranja">Redes</span></th>
                <th width="23" align="center" valign="middle" scope="col"><img src="imagenes/triangulo.jpg" alt="" width="6" height="13" /></th>
                <th width="269" align="left" class="textogris" scope="col">     Actualizar Redes</th>
                </tr>
              </table></th>
          ...
          <input name="id_ar" value="<?php echo $ids; ?> " type="hidden" id="id_ar" size="3" />
            ...
            <tr>
              ...
              <th colspan="2" scope="col">&nbsp;</th>
               ...
               <tr>
              <th align="left" scope="col"><span class="texto">Url</span></th>
              <th colspan="2" align="left" scope="col">&nbsp;&nbsp;&nbsp;
                <label for="url"></label>
                <input name="url" value="<?php echo $url; ?> "type="text" id="url" size="60" /></th>
              </tr>
            <tr>
              <th width="82" scope="col">&nbsp;</th>
              <th colspan="2" scope="col">&nbsp;</th>
              ...
              <td width="614" valign="top"><table width="614" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="614" height="25" align="left" valign="top" class="texto"><input name="imagen" type="file" class="boton2" id="imagen" style="width:400px;"/>
                      <br/><br/><br/><img src="../img/redes/<?php echo $ima; ?>" width="100" height="100"/>
                  </td>
                  </tr>
                <tr>
                  <td height="10" class="texto"><span class="pie-naranja"><strong>Tamaño de Imágen: </strong></span>28 x 27 px</td>
                  </tr>
                <tr>
          ...
          <tr>
            <th width="82" scope="col">&nbsp;</th>
            <th scope="col">&nbsp;</th>
            <th height="40" align="left" scope="col"><form id="form2" name="form2" method="post" action="redes.php?menu=<?php echo $menu;?>">
...
if (isset($_POST['guardar']))
{
	...
	{ 
		if ( (strpos($tipo_archivo4 , "jpeg") || strpos($tipo_archivo4 , "jpg")|| strpos($tipo_archivo4 , "png") || strpos($tipo_archivo4 , "gif")) && ($tamano_imagen4 < 914400000) ) 
		{
			...
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE redes SET imagen='$nombre_archivo4', orden='$orden',url='$url' WHERE id_red=".$ids."";
			mysql_query($qry44, $con_admin) or die(mysql_error());	
			echo"<script language='javascript'>window.location='redes.php?menu=".$menu."'</script>";
		}
		else
		{  
			echo "<script languaje='javascript'>alert('ERROR EN LA IMAGEN')</script>";
			echo"<script language='javascript'>window.location='red_editar_oiu.php?menu=".$menu."&id_red=".$ids."'</script>";	
		}	
	}
	else
	{
		mysql_select_db($database_con_admin, $con_admin);
       $qry44 = "UPDATE redes SET orden='$orden',url='$url' WHERE id_red=".$ids."";
		mysql_query($qry44, $con_admin) or die(mysql_error());	
		echo"<script language='javascript'>window.location='redes.php?menu=".$menu."'</script>";
	}
}
