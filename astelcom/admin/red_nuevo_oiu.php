...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="red_nuevo_oiu.php">
<div id="caja">
...
<div id="caja_tamaños">
    ...
    <span class="pie-naranja"><strong>Tamaño de Imágen: </strong></span>28 x 27 px</p>
</div>
<div id="caja_archivos">
	<p id="seccion" class="texto">Url</p>
  	<p id="caja3">
    	<span><input name="url" class="demos" placeholder="Url:" type="text" id="url" size="60"/></span>
        <br />
    </p>
</div>
<br/>
...
if (isset($_POST['guardar']))
{
	...
	{ 
		if ( strpos($tipo_archivo4 , "png") || strpos($tipo_archivo4 , "gif") ||(strpos($tipo_archivo4 , "jpeg")) ) 
		{
			...
			$qry44 = "INSERT INTO redes (imagen,orden,url) VALUES ('$nombre_archivo4','$orden',url)";
			mysql_query($qry44, $con_admin) or die(mysql_error());
			echo "<SCRIPT LANGUAJE='javascript'>window.location='redes.php' </SCRIPT>";	
		}
		else
		{  
			echo "<script languaje='javascript'>alert('ERROR EN LA IMAGEN')</script>";
			echo"<script language='javascript'>window.location='red_nuevo_oiu.php'</script>";	
		}	
	}
	else
	{
