...
$qry2 = "SELECT * FROM imagenes WHERE id_im='$id_im'";
        ...
        <td align="center"><table width="1000" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <th colspan="3" align="left" scope="col"><table width="392" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th width="100" align="left" scope="col"><span class="textoboldnaranja">Imagenes</span></th>
          ...
          <form id="form1" name="form1" enctype="multipart/form-data" method="post" action="imagen_editar.php">
          <input name="id_im" value="<?php echo $ids; ?> " type="hidden" id="id_im" size="3" />
            <tr>
              ...
              <td width="614" valign="top"><table width="614" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="614" height="25" align="left" valign="top" class="texto"><input name="imagen" type="file" class="boton2" id="imagen" style="width:400px;"/>
                      <br/><br/><br/><img src="../img/imagenes/<?php echo $ima; ?>" width="100" height="100"/>
                  </td>
                  </tr>
                <tr>
                  <td height="10" class="texto"><span class="pie-naranja"><strong>Tamaño de Imágen: </strong></span>246 x 244 px</td>
                  </tr>
                <tr>
          ...
          <tr>
            <th width="82" scope="col">&nbsp;</th>
            <th scope="col">&nbsp;</th>
            <th height="40" align="left" scope="col"><form id="form2" name="form2" method="post" action="imagenes_oi.php?menu=<?php echo $menu;?>">
...
if (isset($_POST['guardar']))
{
	...
	{ 
		...
		{
			if (file_exists("../img/imagenes/" . $ima))
			{
				unlink($carpeta.$ima);
			}
			...
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE imagenes SET imagen='$nombre_archivo4', orden='$orden' WHERE id_im=".$ids."";
			mysql_query($qry44, $con_admin) or die(mysql_error());	
			echo"<script language='javascript'>window.location='imagenes_oi.php?menu=".$menu."'</script>";
		}
		else
		{  
			echo "<script languaje='javascript'>alert('ERROR EN LA IMAGEN')</script>";
			echo"<script language='javascript'>window.location='imagen_editar.php?menu=".$menu."&id_im=".$ids."'</script>";	
		}	
	}
	else
	{
		mysql_select_db($database_con_admin, $con_admin);
       $qry44 = "UPDATE imagenes SET orden='$orden' WHERE id_im=".$ids."";
		mysql_query($qry44, $con_admin) or die(mysql_error());	
		echo"<script language='javascript'>window.location='imagenes_oi.php?menu=".$menu."'</script>";
	}
}
