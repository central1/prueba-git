...
<div id="caja">
	<p class="textoboldnaranja" name="titulo_seccion">Publicacion</p>&nbsp;
        <p id="titulos_actualizar">
    		<img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/>
                <span class="textogris">&nbsp;Actualizar Publicacion</span>
    	</p>
</div>
<?php
mysql_select_db($database_con_admin, $con_admin);
$query = "SELECT COUNT(id_lo) FROM logos";
...
?>  
                <div class="nuevo">
                    <a href="logo_nuevo_i.php"><font color="#000000">Nuevo Logo +</font></a>
                </div>
                
<div id="caja">
	<p id="titulo_nombre">
    	<span class="textogris">    Titulo</span>
    </p>
...
<?php              
mysql_select_db($database_con_admin, $con_admin);
$qry2 = "SELECT * FROM logos ORDER BY orden ASC $pages2->limit";
...
<div id="caja">
    ...
    <img src="../img/logos/<?php echo $ima; ?>" width="330" height="135" class="img_banner"/>
    
</div>
<div id="boton_1">
	<button class="boton-formulario" onclick="location.href='logo_editar_i.php?id_lo=<?php echo $ids; ?>&menu=inicio.php'">Actualizar</button>
</div>
<div id="boton_2">
	<button class="boton-formulario2" onclick="if (confirm('¿Desea eliminar el logo: <?php echo $ima; ?>?')==true){window.location.href='logo_eliminar_i.php?id_lo=<?php echo $ids; ?>&menu=logo_editar_eliminar.php'}">Eliminar</button>
</div>
<?php
	}
}
?>
<form id="form2" name="form2" method="post" action="inicio.php?menu=inicio.php">
