...
$qryt = "SELECT * FROM op1 WHERE seccion='seccion13'";
...
if ( $rt !== false && mysql_num_rows($rt) > 0 ) 
{
	...
	$descripcion = stripslashes($at['descripcion']);
	$ima = stripslashes($at['imagen']);
	$seccion = stripslashes($at['seccion']);		
}
?>
<?php 
          ...
          <tr>
            ...
            <td width="614" valign="top"><table width="614" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                $code = $CKEditor->editor("descripcion", "$descripcion");
                echo $code;
              ?></td>
              </tr>
              <tr>
...
if (isset($_POST['Guardar']))
{
	...
	{ 
		if ( (strpos($tipo_archivo4 , "jpeg") || strpos($tipo_archivo4 , "png") || strpos($tipo_archivo4 , "gif")) && ($tamano_imagen < 2097152) ) 
		{
			...
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE op1 SET titulo='$titulo',descripcion='$descripcion',imagen='$nombre_archivo4' WHERE id_op='13'";	
	...
	{
		mysql_select_db($database_con_admin, $con_admin);
		$qryss = "UPDATE op1 SET titulo='$titulo',descripcion='$descripcion' WHERE id_op='13'";
