...
<div id="caja">
	<p class="textoboldnaranja" name="titulo_seccion">Servicios</p>&nbsp;
...
$query = "SELECT COUNT(id_se) FROM servicios";
...
?>  
                <div class="nuevo">
                    <a href="nuevo_servicio.php?menu=servicios.php&seccion=Servicios"><font color="#000000">Nuevo Servicio +</font></a>
                </div>
<div id="caja">
	<p id="titulo_orden">
...
<?php              
mysql_select_db($database_con_admin, $con_admin);
$qry2 = "SELECT * FROM servicios ORDER BY orden ASC $pages2->limit";
...
<div id="caja">
	...
	<p id="titulo_1">
        ...
        <p id="titulo_1">
    	<span class="texto"><?php echo $titulo;?></span>
        </p>
</div>
<div id="boton_1">
	<button class="boton-formulario" onclick="location.href='servicio_editar.php?id_se=<?php echo $ids; ?>&menu=servicios.php'">Actualizar</button>
</div>
<div id="boton_2">
	<button class="boton-formulario2" onclick="if (confirm('¿Desea eliminar el servicio: <?php echo $titulo; ?>?')==true){window.location.href='servicio_eliminar.php?id_se=<?php echo $ids; ?>&menu=servicios.php'}">Eliminar</button>
</div>
<?php
	}
}
?>
<form id="form2" name="form2" method="post" action="servicios.php">
