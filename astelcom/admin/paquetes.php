...
<div id="caja">
	<p class="textoboldnaranja" name="titulo_seccion">Paquetes</p>&nbsp;
...
$query = "SELECT COUNT(id_pro) FROM promociones";
...
?>  
                <div class="nuevo">
                    <a href="nuevo_paquete.php"><font color="#000000">Nuevo Paquete +</font></a>
                </div>
<div id="caja">
	<p id="titulo_orden">
...
<?php              
mysql_select_db($database_con_admin, $con_admin);
$qry2 = "SELECT * FROM promociones ORDER BY orden ASC $pages2->limit";
...
<div id="boton_1">
	<button class="boton-formulario" onclick="location.href='paquete_editar.php?id_pro=<?php echo $ids; ?>&menu=promociones.php'">Actualizar</button>
</div>
<div id="boton_2">
	<button class="boton-formulario2" onclick="if (confirm('¿Desea eliminar el paquete: <?php echo $titulo; ?>?')==true){window.location.href='paquete_eliminar.php?id_pro=<?php echo $ids; ?>&menu=promociones.php'}">Eliminar</button>
</div>
<?php
	}
}
?>
<form id="form2" name="form2" method="post" action="promociones.php?menu=promociones.php">
