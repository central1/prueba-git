        ...
        <td align="center"><table width="1000" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <th colspan="3" align="left" scope="col"><table width="392" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th width="100" align="left" scope="col"><span class="textoboldnaranja">Promocion</span></th>
          ...
          <input name="id_op" value="<?php echo $ids; ?> " type="hidden" id="id_op" size="3" />          
            <tr>
            <tr>
              <th align="left" scope="col"><span class="texto">Titulo</span></th>
              <th colspan="2" align="left" scope="col">&nbsp;&nbsp;&nbsp;
                <label for="titulo"></label>
                <input name="titulo" value="<?php echo $titulo1; ?> "type="text" id="titulo" size="60" /></th>
              </tr>
            <tr>
              ...
              <tr>
              <th align="left" scope="col"><span class="texto">Subtitulo</span></th>
              <th colspan="2" align="left" scope="col">&nbsp;&nbsp;&nbsp;
                <label for="subtitulo"></label>
                <input name="subtitulo" value="<?php echo $subtitulo1; ?> "type="text" id="subtitulo" size="10" /></th>
              </tr>
            <tr>
              <th width="82" scope="col">&nbsp;</th>
              <th colspan="2" scope="col">&nbsp;</th>
...
if (isset($_POST['guardar']))
			{
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE op1 SET titulo='$titulo',subtitulo='$subtitulo',descripcion='$descripcion',tex1='$tex1',tex2='$tex2',tex3='$tex3' WHERE id_op=".$ids."";
			mysql_query($qry44, $con_admin) or die(mysql_error());	
			echo"<script language='javascript'>window.location='promociones.php?menu=".$menu."'</script>";
