...
<?php
mysql_select_db($database_con_admin, $con_admin);
$qryt = "SELECT * FROM op1 WHERE seccion='seccion15'";
       ...
       <input name="seccion" type="hidden" value="<?php echo $sec; ?>" />
          <tr>
            <td height="166" valign="top"><table width="82" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="20" align="left" valign="middle" class="texto">Subtitulo</td>
              </tr>
              <tr>
...
{
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE op1 SET titulo='$titulo',subtitulo='$subtitulo' WHERE id_op='$id_op'";	
