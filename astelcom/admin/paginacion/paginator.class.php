...
//			$this->items_per_page = $this->default_ipp;
		...
		if($this->num_pages > 10)
		{
			...
			$this->return .= (($this->current_page < $this->num_pages And $this->items_total >= 10) And ($_GET['page'] != 'All') And $this->current_page > 0) ? "<a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$next_page&ipp=$this->items_per_page$this->querystring\">Siguiente &raquo;</a>\n":"<span class=\"inactive\" href=\"#\">Siguiente &raquo;</span>\n";
			$this->return .= ($_GET['page'] == 'All') ? "<a class=\"current\" style=\"margin-left:10px\" href=\"#\">Todos</a> \n":"<a class=\"paginate\" style=\"margin-left:10px\" href=\"$_SERVER[PHP_SELF]?page=1&ipp=All$this->querystring\">Todos</a> \n";
		}
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
