...
<div id="caja">
	<p class="textoboldnaranja" id="titulo_secciones"><?php echo $tit;?></p>
  	<p id="titulos_actualizar">
    	<img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="botones"><a href="op1_td_editarpt.php?menu=promociones.php&seccion=<?php echo $secc;?>" class="botones"> Actualizar +</a></span>
    </p>
    </div>
<div id="caja_separador"><img src="imagenes/plecahorizontal.jpg" alt="" width="800" height="9"/ class="pleca_separador"></div>
<div id="caja">
	<p class="textoboldnaranja" id="titulo_secciones">Imagenes</p>
  	<p id="titulos_actualizar">
    	<img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="botones"><a href="imagenes_oi.php?menu=promociones.php" class="botones"> Actualizar Imagenes +</a></span>
    </p>
    </div>
    <div id="caja_separador"><img src="imagenes/plecahorizontal.jpg" alt="" width="800" height="9"/ class="pleca_separador"></div>
<?php              
mysql_select_db($database_con_admin, $con_admin);
$qry1 = "SELECT * FROM op1 where seccion='seccion8'";
...
<div id="caja">
	<p class="textoboldnaranja" id="titulo_secciones"><?php echo $tit1;?></p>
  	<p id="titulos_actualizar">
    <img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="botones"><a href="op1_t_editarpp.php?menu=promociones.php&seccion=<?php echo $secc1;?>" class="botones"> Actualizar +</a></span>
    <br/><br/>
    <img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="botones"><a href="nuevo_paquete.php?menu=promociones.php" class="botones"> Nuevo Paquete +</a></span>
    <br/><br/>
    	<img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="botones"><a href="paquetes.php?menu=promociones.php" class="botones"> Actualizar Paquetes +</a></span>
    </p>
    </div>
    <div id="caja_separador"><img src="imagenes/plecahorizontal.jpg" alt="" width="800" height="9"/ class="pleca_separador"></div>
    
    <div id="caja">
	<p class="textoboldnaranja" id="titulo_secciones">Paquete Statico</p>
  	<p id="titulos_actualizar">
    	<img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="botones"><a href="paquete_editar1.php?menu=promociones.php" class="botones"> Actualizar +</a></span>
    </p>
    </div>
  ...
  <?php              
mysql_select_db($database_con_admin, $con_admin);
$qry2 = "SELECT * FROM op1 where seccion='seccion9'";
...
<div id="caja">
	<p class="textoboldnaranja" id="titulo_secciones"><?php echo $tit2;?></p>
  	<p id="titulos_actualizar">
    	<img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="botones"><a href="op1_tsii_editarpll.php?menu=promociones.php&seccion=<?php echo $secc2;?>" class="botones"> Actualizar +</a></span>
    </p>
    </div>
<!--FIN DEL ADMIN-->
<div id="caja_end">
