...
<form id="form1" name="form1" enctype="multipart/form-data" method="post" action="nuevo_servicio.php">
<div id="caja">
	<p class="textoboldnaranja" id="titulo_seccion" name="titulo_seccion">Servicio</p>
...
<form id="form2" name="form2" method="post" action="servicio.php?menu=servicios.php&seccion=Servicios">
<p id="boton_2">
...
if (isset($_POST['guardar']))
{
			...
			$qry44 = "INSERT INTO servicios (orden,titulo,descripcion) VALUES ('$orden','$titulo','$descripcion')";
			mysql_query($qry44, $con_admin) or die(mysql_error());
			echo "<SCRIPT LANGUAJE='javascript'>window.location='servicio.php?menu=servicios.php&seccion=Servicios' </SCRIPT>";	
		}
