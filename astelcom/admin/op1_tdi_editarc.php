...
<?php
mysql_select_db($database_con_admin, $con_admin);
$qryt = "SELECT * FROM op1 WHERE seccion='seccion10'";
       ...
       <input name="imagen" type="hidden" value="<?php echo $ima; ?>" />
          <tr>
            ...
            <th width="288" rowspan="2" align="right" valign="top" scope="col"><table width="288" border="0" align="right" cellpadding="0" cellspacing="0">
             <?php 
			  ...
			  ?>
              <tr>
                <td align="left"><img src="../img/op/<?php echo $ima; ?>" width="<?php echo $tam_width; ?>" height="<?php echo $tam_height; ?>" /></td>
              </tr>
              <tr>
                <td height="8" align="left"></td>
              </tr>
              <tr>
                <td align="left"><span class="texto"><span class="pie-naranja"><strong>Tamaño</strong> </span><?php echo $tam1; ?> x <?php echo $tam2; ?> px</span></td>
              </tr>
              <tr>
                <td height="8" align="left"></td>
              </tr>
          ...
          <tr>
           ...
           <tr>
            ...
            <th scope="col">&nbsp;</th>
            <th align="left" scope="col"><form id="form2" name="form2" method="post" action="contacto.php">
...
if (isset($_POST['Guardar']))
{
	...
	{ 
		if ( (strpos($tipo_archivo4 , "jpeg") || strpos($tipo_archivo4 , "png") || strpos($tipo_archivo4 , "gif")) && ($tamano_imagen < 2097152) ) 
		{
			...
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE op1 SET titulo='$titulo',subtitulo='$subtitulo',descripcion='$descripcion',imagen='$nombre_archivo4' WHERE id_op='$id_op'";	
		...
		{  
			...
			echo"<script language='javascript'>window.location='op1_tdis_editars.php?menu=".$menu."&seccion=".$seccion."'</script>";					
		}
	}
	else
	{
		mysql_select_db($database_con_admin, $con_admin);
		$qryss = "UPDATE op1 SET titulo='$titulo',subtitulo='$subtitulo',descripcion='$descripcion' WHERE id_op='$id_op'";
