       ...
       <input name="imagen" type="hidden" value="<?php echo $ima; ?>" />
          ...
          <tr>
           ...
           <tr>
            ...
            <th scope="col">&nbsp;</th>
            <th align="left" scope="col"><form id="form2" name="form2" method="post" action="servicios.php">
...
if (isset($_POST['Guardar']))
{
	...
	{ 
		if ( (strpos($tipo_archivo4 , "jpeg") || strpos($tipo_archivo4 , "png") || strpos($tipo_archivo4 , "gif")) && ($tamano_imagen < 2097152) ) 
		{
			...
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE op1 SET titulo='$titulo',descripcion='$descripcion',imagen='$nombre_archivo4' WHERE id_op='$id_op'";	
	...
	{
		mysql_select_db($database_con_admin, $con_admin);
		$qryss = "UPDATE op1 SET titulo='$titulo',descripcion='$descripcion' WHERE id_op='$id_op'";
