...
<div id="caja">
	<p class="textoboldnaranja" name="titulo_seccion">Redes</p>&nbsp;
...
$query = "SELECT COUNT(id_red) FROM redes";
...
?>  
                <div class="nuevo">
                    <a href="red_nuevo_oiu.php"><font color="#000000">Nueva Red +</font></a>
                </div>
<div id="caja">
	<p id="titulo_orden">
...
<?php              
mysql_select_db($database_con_admin, $con_admin);
$qry2 = "SELECT * FROM redes ORDER BY orden ASC $pages2->limit";
...
<div id="caja">
    ...
    <img src="../img/redes/<?php echo $ima; ?>" width="330" height="135" class="img_banner"/>
    
</div>
<div id="boton_1">
	<button class="boton-formulario" onclick="location.href='red_editar_oiu.php?id_red=<?php echo $ids; ?>&menu=inicio.php'">Actualizar</button>
</div>
<div id="boton_2">
	<button class="boton-formulario2" onclick="if (confirm('¿Desea eliminar la red: <?php echo $ima; ?>?')==true){window.location.href='red_eliminar_oiu.php?id_red=<?php echo $ids; ?>&menu=inicio.php'}">Eliminar</button>
</div>
<?php
	}
}
