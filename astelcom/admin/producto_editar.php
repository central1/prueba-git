...
$qry2 = "SELECT * FROM productos WHERE id_p='$id_p'";
$r2 = mysql_query($qry2, $con_admin) or die(mysql_error());
if ( $r2 !== false && mysql_num_rows($r2) > 0 ) 
{
	$a2 = mysql_fetch_assoc($r2);
	$ids = stripslashes($a2['id_p']);
	$id_c= stripslashes($a2['id_ca']);
        ...
        <td align="center"><table width="1000" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <th colspan="3" align="left" scope="col"><table width="392" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th width="100" align="left" scope="col"><span class="textoboldnaranja">Productos</span></th>
          ...
          <input name="id_p" value="<?php echo $ids; ?> " type="hidden" id="id_p" size="3" />
            <tr>
              ...
              <td width="614" valign="top"><table width="614" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="614" height="25" align="left" valign="top" class="texto"><input name="imagen" type="file" class="boton2" id="imagen" style="width:400px;"/>
                      <br/><br/><br/><img src="../img/productos/<?php echo $ima; ?>" width="100" height="100"/>
                  </td>
                  </tr>
                <tr>
                  <td height="10" class="texto"><span class="pie-naranja"><strong>Tamaño de Imágen: </strong></span>200 x 175 px</td>
                  </tr>
                  <tr>
              <th width="82" scope="col">&nbsp;</th>
              <th colspan="2" scope="col">&nbsp;</th>
                  ...
                  <tr>
              <th align="left" scope="col"><span class="texto">Descripcion
                <?php
          ...
          <tr>
            <th width="82" scope="col">&nbsp;</th>
            <th scope="col">&nbsp;</th>
            <th height="40" align="left" scope="col"><form id="form2" name="form2" method="post" action="productos.php?id_ca=<?php echo $id_ca;?>&menu=galeria.php">
...
if (isset($_POST['guardar']))
{
	...
	{ 
		...
		{
			if (file_exists("../img/productos/" . $ima))
			{
				unlink($carpeta.$ima);
			}
			...
			mysql_select_db($database_con_admin, $con_admin);
			$qry44 = "UPDATE productos SET imagen='$nombre_archivo4', orden='$orden',titulo='$titulo',descripcion='$descripcion' WHERE id_p=".$ids."";
			mysql_query($qry44, $con_admin) or die(mysql_error());	
			echo"<script language='javascript'>window.location='productos.php?id_ca=$id_ca&menu=galeria.php'</script>";
		}
		else
		{  
			echo "<script languaje='javascript'>alert('ERROR EN LA IMAGEN')</script>";
			echo"<script language='javascript'>window.location='producto_editar.php?menu=galeria.php&id_p=".$ids."'</script>";	
		}	
	}
	else
	{
		mysql_select_db($database_con_admin, $con_admin);
       $qry44 = "UPDATE productos SET orden='$orden',titulo='$titulo',descripcion='$descripcion' WHERE id_p=".$ids."";
		mysql_query($qry44, $con_admin) or die(mysql_error());	
		echo"<script language='javascript'>window.location='productos.php?id_ca=$id_ca&menu=galeria.php'</script>";
	}
}
