...
$qry = "SELECT * FROM op1 where seccion='seccion6'";
...
<div id="caja">
	<p class="textoboldnaranja" id="titulo_secciones"><?php echo $tit;?></p>
  	<p id="titulos_actualizar">
    	<img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="botones"><a href="op1_t_editare.php?menu=galeria.php&seccion=<?php echo $secc;?>" class="botones"> Actualizar +</a></span>
    </p>
    </div>
<div id="caja_separador"><img src="imagenes/plecahorizontal.jpg" alt="" width="800" height="9"/ class="pleca_separador"></div>
<div id="caja">
	<p class="textoboldnaranja" id="titulo_secciones">Categorias</p>
  	<p id="titulos_actualizar">
    	<img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="botones"><a href="categoria_nuevo.php?menu=galeria.php" class="botones"> Nueva Categoria+</a></span>
        <br/><br/>
    	<img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="botones"><a href="categoria.php?menu=galeria.php" class="botones"> Actualizar Categorias +</a></span>
    </p>
    </div>
<!--FIN DEL ADMIN-->
<div id="caja_end">
