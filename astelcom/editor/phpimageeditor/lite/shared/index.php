...
<style type="text/css">
body {
	background-image: url(../../admin/imagenes/fondo.jpg);
...
#menushb tr td a{
	...
	background-color: #821631;
	border-radius:3px;
}

#menushb tr td a:hover{
	font-family: 'Open Sans', sans-serif;
	font-weight:400;
	font-size: 14px;
	color: #821631;
...
<table width="326" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <th height="750" align="left" valign="top" scope="col">
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="135" height="101" align="left" valign="bottom">
        <img src="../../admin/imagenes/logo.jpg" width="214" height="73" border="0" /></td>
        <td width="837" height="48" align="right" valign="bottom"><table width="500" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td width="391" align="right" valign="top" class="textoboldnaranja">Editor de imágenes<span class="textoboldgris"> | Administrador de Contenidos </span> </td>
          </tr>
          <tr>
            <td height="31">&nbsp;</td>
          </tr>
          <tr>
            <td align="right" valign="top"><table width="93" border="0" cellspacing="0" cellpadding="0" id="menushb">
          <tr>
            <td width="93" height="26" align="center"><a href="../../admin/inicio.php?menu=inicio.php">Regresar</a></td>
          </tr>
        </table></td>
          </tr>
        </table></td>
      ...
      <tr>
        <td width="163" height="19" align="left" valign="top">&nbsp;</td>
        <td width="837" align="right" valign="bottom">&nbsp;</td>
      </tr>
      <tr>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="116" align="left" valign="middle" class="pie">&nbsp;</td>
        <td align="right" valign="middle" class="pie">&nbsp;</td>
  </tr>
  <tr>
        <td height="116" align="left" valign="middle" class="pie">&nbsp;</td>
        <td align="right" valign="middle" class="pie">&nbsp;</td>
